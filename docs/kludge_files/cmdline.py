...
def main(argv=sys.argv[1:]):  # type: ignore
    ...
    # For some reason the output directory is the first entry in the list. Remove it
    args.filenames.remove(args.outputdir)

    # Add path to each file
    for i in xrange(0,len(args.filenames)):
        args.filenames[i] = args.sourcedir + '/' + args.filenames[i]
